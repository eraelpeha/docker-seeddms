...
RUN apt-get update && apt-get install libpng-dev libpq-dev -y
...
# Get seeddms
RUN curl -fsSL https://downloads.sourceforge.net/project/seeddms/seeddms-6.0.7/seeddms-quickstart-6.0.7.tar.gz | tar -xzC /var/www
